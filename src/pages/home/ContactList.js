...
export function renderContactList(contacts) {
  const container = document.createElement("div"); // ✅ conteneur DOM

  contacts.forEach((contact) => {
    const card = document.createElement("div");
    card.className = "px-4 py-3 flex items-center space-x-3 cursor-pointer hover:bg-gray-700 border-b border-gray-600";
    ...
    container.appendChild(card); // ✅ injecté dans le conteneur
  });

  return container; // ✅ retourne un vrai HTMLElement, plus une string
}
